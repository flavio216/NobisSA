...
namespace NobisSA.Envios
{
    partial class rprtEnvios
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.enviosTableAdapter = new NobisSA.dtsPrincipalTableAdapters.EnviosTableAdapter();
            ...
            reportDataSource1.Value = this.enviosBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "NobisSA.Envios.infEnvios.rdlc";
            ...
            this.enviosBindingSource.DataSource = this.dtsPrincipal;
            // 
            // enviosTableAdapter
            // 
            ...
            this.Name = "rprtEnvios";
            this.Text = "rprtEnvios";
            this.Load += new System.EventHandler(this.rprtEnvios_Load);
        ...
        private dtsPrincipalTableAdapters.EnviosTableAdapter enviosTableAdapter;
    }
}